...
<div class="grid grid-flow-col gap-[15px] p-4 bg-black/10 rounded" style={`grid-template-rows: repeat(${grid.sizey}, minmax(0, 1fr)); grid-template-columns: repeat(${grid.sizex}`}>
